...
export class AuthService {
  ...
  static async register(data: any) {
    ...
    // ✅ 1. FIELD VALIDATION (same as login)
  ...
  static async verifyOtp(data: any) {
    ...
    if (otp && otp.length !== 6) {
      fieldErrors.otp = "OTP must be 6 digits";
    }
    ...
    const activeMember = verifiedUser.member[0];
